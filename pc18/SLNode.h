/*
 * SLNode.h for Programming Challenge 18
 * This file contains the function declarations for SLNode.cpp in order to
 * construct, destruct, and manipulate the contents or pointer of a Node.
 *
